...
function updatetk($email,$user,$phone,$address,$id)
{
    
        $sql = "update taikhoan set user = '{$user}',email = '{$email}',address = '{$address}',tel = '{$phone}' where id = '{$id}'";

    pdo_execute($sql);
    //  var_dump($sql);
}
function edit_mk($id,$pass)
{
